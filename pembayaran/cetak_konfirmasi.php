...
if ($tgl_dari) $where .= " AND p.tanggal_konfirmasi >= '$tgl_dari 00:00:00'";
if ($tgl_sampai) $where .= " AND p.tanggal_konfirmasi <= '$tgl_sampai 23:59:59'";
...
$statusColor = ['pending' => '#f39c12', 'dikonfirmasi' => '#27ae60', 'ditolak' => '#e74c3c'];

$judul_cetak = "Data Konfirmasi Pembayaran";
...
<body>
    ...
    <table>
        ...
        <?php $no = 1; $total = 0; while ($row = mysqli_fetch_assoc($data)) : ?>
            <tr>
                <td><?= $no++ ?></td>
